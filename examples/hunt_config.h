/* Hunt Configuration
 * As of May 11th, 2016 at ThrowTheSwitch/Hunt commit 837c529
 * Update: December 29th, 2016
 * See Also: Hunt/docs/HuntConfigurationGuide.pdf
 *
 * Hunt is designed to run on almost anything that is targeted by a C compiler.
 ...
 * hunt_internals.h header file. We don't necessarily recommend opening that
 ...
 *  2. You can create a custom `hunt_config.h` configuration file (present in
 ...
 *     `HUNT_INCLUDE_CONFIG_H` and Hunt will rely on `hunt_config.h` for any
 ...
 * encounter. Therefore, Hunt has a number of features for helping to adjust
 ...
 * want Hunt to check this file, define this to make it skip the inclusion.
 * Hunt looks at UINT_MAX & ULONG_MAX, which were available since C89.
 */
/* #define HUNT_EXCLUDE_LIMITS_H */

/* The second thing that Hunt does to guess your types is check `stdint.h`.
 * This file defines `UINTPTR_MAX`, since C99, that Hunt can make use of to
 ...
 * you're going to want to define this. That way, Hunt will know to skip the
 ...
 * hand-coded. To keep Hunt universal, though, we eventually chose to develop
 * our own floating point print routines. Still, the display of floating point
 * values during a failure are optional. By default, Hunt will print the
...
/* If enabled, Hunt assumes you want your `DOUBLE` asserts to compare standard
 * C doubles. If you would like to change this, you can specify something else
 * by using this option. For example, defining `HUNT_DOUBLE_TYPE` to `long
 ...
 * documented in the Hunt Assertion Guide, you will learn that they are not
 ...
 * 10^-12. For further details on how this works, see the appendix of the Hunt
 * Assertion Guide.
 *
 * Example:
 */
/* #define HUNT_FLOAT_PRECISION 0.001f  */
/* #define HUNT_DOUBLE_PRECISION 0.001f */


/* *************************** MISCELLANEOUS ***********************************
 * Miscellaneous configuration options for Hunt
 **************************************************************************** */

/* Hunt uses the stddef.h header included in the C standard library for the
...
/* Define this to enable the hunt formatted print function:
 * "HuntPrintFormatted"
 */
 ...
 * `HUNT_OUTPUT_CHAR` macro. This macro accepts a single character at a time
...
/* #define HUNT_OUTPUT_CHAR_HEADER_DECLARATION    RS232_putc(int) */
/* #define HUNT_OUTPUT_FLUSH()                    RS232_flush() */
/* #define HUNT_OUTPUT_FLUSH_HEADER_DECLARATION   RS232_flush(void) */
/* #define HUNT_OUTPUT_START()                    RS232_config(115200,1,8,0) */
/* #define HUNT_OUTPUT_COMPLETE()                 RS232_close() */

/* For some targets, Hunt can make the otherwise required `setUp()` and
 ...
 * it never existed. If your compiler supports this feature, you can let Hunt
 * know by defining `HUNT_SUPPORT_WEAK` as the function attributes that would
 ...
 */
/* #define HUNT_SUPPORT_WEAK weak */
/* #define HUNT_SUPPORT_WEAK __attribute__((weak)) */
/* #define HUNT_NO_WEAK */

/* Some compilers require a custom attribute to be assigned to pointers, like
 * `near` or `far`. In these cases, you can give Hunt a safe default for these
